...
function IOSStatusBar({ dark = false, time = '9:41' }) {
  ...
  return (
    <div data-component="IOSStatusBar" style={{
...
export function IOSGlassPill({ children, dark = false, style = {} }) {
  return (
    <div data-component="IOSGlassPill" style={{
...
export function IOSNavBar({ title = 'Title', dark = false, trailingIcon = true }) {
  ...
  return (
    <div data-component="IOSNavBar" style={{
...
export function IOSListRow({ title, detail, icon, chevron = true, isLast = false, dark = false }) {
  ...
  return (
    <div data-component="IOSListRow" style={{
...
export function IOSKeyboard({ dark = false }) {
  ...
  return (
    <div data-component="IOSKeyboard" style={{
...
export default function IOSDevice({
  ...
  return (
    <div data-component="IOSDevice" style={{
